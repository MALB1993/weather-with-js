...
weatherApp.fetchWeatherData("tehran").then((response) => { // Fetching weather data asynchronously
    console.log(response); // Logging the entire response object for debugging purposes
